...
Gem::Specification.new do |s|
  ...
  s.files = [
    "LICENSE",
     "Rakefile",
     "VERSION",
     "dm-sqlite3-adapter.gemspec",
     "lib/sqlite3_adapter.rb",
     "lib/sqlite3_adapter/adapter.rb",
  ...
  s.homepage = %q{http://github.com/datamapper/dm-more/tree/master/adapters/dm-sqlite3-adapter}
